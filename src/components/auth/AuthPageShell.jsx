...
export default function AuthPageShell({
  ...
  return (
    <div className="min-h-[100dvh] bg-[radial-gradient(circle_at_top_right,rgba(96,165,250,0.16),transparent_22%),radial-gradient(circle_at_bottom_right,rgba(139,92,246,0.14),transparent_24%),linear-gradient(180deg,#f8fafc_0%,#eef2ff_100%)]">
      <div className="grid min-h-[100dvh] desktop:grid-cols-[minmax(0,1.02fr)_minmax(0,0.98fr)]">
        <aside className="relative hidden overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(96,165,250,0.12),transparent_18%),radial-gradient(circle_at_bottom_right,rgba(139,92,246,0.2),transparent_28%),linear-gradient(180deg,#050816_0%,#070c1d_55%,#0a1025_100%)] px-8 py-10 desktop:block desktop:px-10">
          ...
          <div className="relative z-10 flex h-full flex-col">
            ...
            <MotionReveal className={mode === "register" ? "mt-12" : "mt-auto"} preset="viewportReveal">
              ...
              <>
                <MotionReveal className="mt-8 grid grid-cols-3 gap-4" preset="viewportReveal">
                  {copy.stats.map((stat) => (
                    <div
                      key={stat.label}
                      className="rounded-[22px] border border-primary/20 bg-white/[0.04] px-5 py-5 text-white shadow-[0_12px_40px_rgba(15,23,42,0.18)]"
                    >
        ...
        <section className="relative flex min-h-[100dvh] items-center justify-center px-4 py-10 sm:px-6 desktop:px-10">
